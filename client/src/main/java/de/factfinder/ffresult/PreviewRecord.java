...
@JsonPropertyOrder({"searchSimilarity", "position", "id", "record", "keywords", "foundWords", "simiMalusAdd"})
public class PreviewRecord {
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(searchSimilarity).append(position).append(id).append(record).append(keywords).append(foundWords)
									.append(simiMalusAdd).toHashCode();
	}

	@Override
	public boolean equals(Object other) {
		if (other == this) { return true; }
		if ((other instanceof PreviewRecord) == false) { return false; }
		PreviewRecord rhs = ((PreviewRecord) other);
		return new EqualsBuilder().append(searchSimilarity, rhs.searchSimilarity).append(position, rhs.position).append(id, rhs.id).append(record, rhs.record)
									.append(keywords, rhs.keywords).append(foundWords, rhs.foundWords).append(simiMalusAdd, rhs.simiMalusAdd).isEquals();
	}
