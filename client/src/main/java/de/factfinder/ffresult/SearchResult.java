...
public class SearchResult {
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof SearchResult) == false) { return false; }
	...
	public enum ResultArticleNumberStatus {
		...
		NO_ARTICLE_NUMBER_SEARCH("noArticleNumberSearch"), NOTHING_FOUND("nothingFound"), RESULTS_FOUND("resultsFound");
	...
	public enum ResultStatus {
		...
		RESULTS_FOUND("resultsFound"), NOTHING_FOUND("nothingFound"), ERROR_OCCURED("errorOccured");
		private final String										value;
