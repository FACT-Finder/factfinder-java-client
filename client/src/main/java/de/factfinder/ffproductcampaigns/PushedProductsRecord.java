...
public class PushedProductsRecord {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(id).append(record).append(simiMalusAdd).append(simiMalusMul).append(foundWords).append(keywords).append(position).append(searchSimilarity).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(id, rhs.id).append(record, rhs.record).append(simiMalusAdd, rhs.simiMalusAdd).append(simiMalusMul, rhs.simiMalusMul).append(foundWords, rhs.foundWords).append(keywords, rhs.keywords).append(position, rhs.position).append(searchSimilarity, rhs.searchSimilarity).isEquals();
    }
