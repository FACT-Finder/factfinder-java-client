...
public class ApiClient {
    ...
    private String basePath = "https://demoshop.fact-finder.de/FACT-Finder/rest";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://demoshop.fact-finder.de/FACT-Finder/rest
