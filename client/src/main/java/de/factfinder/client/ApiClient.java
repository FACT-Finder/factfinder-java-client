...
import de.factfinder.client.auth.Authentication;
import de.factfinder.client.auth.HttpBasicAuth;
import de.factfinder.client.auth.HttpBearerAuth;
import de.factfinder.client.auth.ApiKeyAuth;
import de.factfinder.client.auth.OAuth;
import de.factfinder.client.auth.RetryingOAuth;
import de.factfinder.client.auth.OAuthFlow;

public class ApiClient {

    private String basePath = "http://!!!DO NOT MANUALLY EDIT THIS FILE!!! Update files in this directory with ./gradlew :itests:default:test -PgenerateSpec";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://!!!DO NOT MANUALLY EDIT THIS FILE!!! Update files in this directory with ./gradlew :itests:default:test -PgenerateSpec
